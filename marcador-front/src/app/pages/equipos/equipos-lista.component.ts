...
export class EquiposListaComponent implements OnInit {
  ...
  private cargarLista(): void {
    ...
    this.svc.listPaged({
      ...
      next: (res: any) => {
        // Backend devuelve { items, totalItems, page, pageSize }
  ...
  get rangeStart(): number { return this.totalItems ? (this.page - 1) * this.pageSize + 1 : 0; }
  get rangeEnd(): number { return Math.min(this.page * this.pageSize, this.totalItems); }
